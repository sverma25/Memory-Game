...
public class RandomActivity extends Activity implements HintDialog.CommunicationChannel{
    ...
    protected Button submit_Button, reset_Button, hint_Button;

    protected TextView triesText;
    protected int tries = 5, gameNum = 1;
        ...
        submit_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) throws NullPointerException {
                ...
                if (!b) {
                    ...
                    if (tries == 0) {
                        Toast.makeText(RandomActivity.this, "Maybe next time man",
